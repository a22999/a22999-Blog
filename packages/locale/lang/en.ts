export default {
  ...
  tk: {
    ...
    articleTags: {
      label: "Article Tags",
      title: "Article Tags",
      tagAriaLabel: "Tag: {tag}, click to view related articles",
    },
    articleOverview: {
    ...
    tagsPage: {
      ...
      nextPage: "Next page",
      pagination: "Tags pagination navigation",
      tagList: "Tags list",
      tagAriaLabel: "Tag {tag}, {count} articles",
      tagGroup: "Tags starting with {letter}",
      tagSelected: "Selected tag {tag}, {count} articles",
      filterCleared: "Tag filter cleared",
      clearFilter: "Clear tag filter",
      clearSearch: "Clear search",
      searchCleared: "Search cleared",
      searchDesc: "Enter keywords to search tags, press down arrow to navigate to tag list",
      pageAnnounce: "Page {page} of {total}",
      ariaLiveRegion: "Tags page status",
      keyboardHint: "Use arrow keys to navigate, Enter to select, ESC to clear",
      timeline: {
        label: "Timeline",
        year: "{year}",
        month: "{month}",
