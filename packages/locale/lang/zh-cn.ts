export default {
  ...
  tk: {
    ...
    tagsPage: {
      ...
      noResult: "未找到匹配的标签",
      loadMore: "加载更多",
      showingRange: "显示第 {start}-{end} 个，共 {total} 个",
      prevPage: "上一页",
      nextPage: "下一页",
      pagination: "标签分页导航",
      tagList: "标签列表",
      tagAriaLabel: "标签 {tag}，共 {count} 篇文章",
      tagGroup: "{letter} 开头的标签",
      tagSelected: "已选择标签 {tag}，共 {count} 篇文章",
      filterCleared: "已清除标签筛选",
      clearFilter: "清除标签筛选",
      clearSearch: "清除搜索",
      searchCleared: "搜索已清除",
      searchDesc: "输入关键词搜索标签，按向下箭头键进入标签列表",
      pageAnnounce: "第 {page} 页，共 {total} 页",
      ariaLiveRegion: "标签页面状态",
      keyboardHint: "使用方向键导航，Enter 选择，ESC 清除",
      timeline: {
        label: "时间线",
        year: "{year} 年",
        month: "{month} 月",
