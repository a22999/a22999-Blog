...
export const teekConfig = defineTeekConfig({
  ...
  bodyBgImg: {
    imgSrc: ["/blog/bg1.png"], // body 背景图片链接。单张图片 string | 多张图片 string[], 多张图片时每隔 imgInterval 秒换一张
  ...
  banner: {
    ...
    name: "🎉 a22999's Blog", // Banner 标题，默认读取 vitepress 的 title 属性
    bgStyle: "fullImg", // Banner 背景风格：pure 为纯色背景，partImg 为局部图片背景，fullImg 为全屏图片背景
    pureBgColor: "#28282d", // Banner 背景色，bgStyle 为 pure 时生效
    imgSrc: ["/blog/bg1.png"], // Banner 图片链接。bgStyle 为 partImg 或 fullImg 时生效
  ...
  blogger: {
    ...
    slogan: "", // 博主签名
    avatar:
      "https://6c6f-lowcode-1gp721m6b69673df-1312959697.tcb.qcloud.la/test/background/avatar.png?sign=6dbc633b9b6cc22df6c403e9feed270f&t=1757488018", // 博主头像
    shape: "circle-rotate", // 头像风格：square 为方形头像，circle 为圆形头像，circle-rotate 可支持鼠标悬停旋转，circle-rotate-last 将会持续旋转 59s
    circleBgImg: "/blog/bg1.png", // 背景图片
  ...
  // 站点信息卡片配置
  docAnalysis: {
    enabled: false, // 是否启用站点信息卡片
    createTime: "2025-09-10", // 站点创建时间
    ...
    // 自定义额外信息
    appendInfo: [
      // { key: "index", label: "站点作者", value: "Teeker" }
    ],
  },
  ...
  vitePlugins: {
    ...
    sidebarOption: {
      ignoreList: ["归档(无用)", "OBSIDIAN_GUIDE.md", ".obsidian"], // 忽略归档目录、Obsidian 管理规范文档、以及 .obsidian 配置目录（不忽略 obsidian 文章目录）
    }, // sidebar 插件配置项
    ...
    fileContentLoaderIgnore: [
      ...
      "**/examples/**",
      "**/归档(无用)/**",
      "**/OBSIDIAN_GUIDE.md", // 忽略 Obsidian 管理规范文档
    ], // fileContentLoader 插件扫描 markdown 文档时，指定忽略路径，格式为 glob 表达式
    autoFrontmatter: true, // 是否启用 autoFrontmatter 插件
    // autoFrontmatter 插件配置项
    autoFrontmatterOption: {
      permalinkPrefix: "", // 自动生成 permalink 的固定前缀，设置为空以支持自定义permalink路径
